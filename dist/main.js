...
var Articulo = function Articulo(id, descripcion, valor, categoria) {
...
function getDatos(datos) {
  for (var i = 0; i < datos.length; i++) {
    ...
    document.querySelector('#list').innerHTML += "<tr class=\"table__tr\"><td class=\"table__td\">".concat(id, "</td><td class=\"table__td\">").concat(descripcion, "</td><td class=\"table__td\">").concat(valor, "</td><td class=\"table__td\">").concat(categoria, "</td></tr>");
  }
}
...
document.querySelector('#add').addEventListener('click', function () {
  id++;
  var descripcion = document.querySelector('#add_descripcion').value;
  var valor = document.querySelector('#add_valor').value;
  var categoria = document.querySelector('#opc').value;

  if (descripcion != '' && valor != '' && categoria != '') {
    var objArticulo = new _articulo.Articulo(id, descripcion, valor, categoria);
    listInventario.push(objArticulo);
    (0, _funcionalidad.cleanInputs)();
  } else {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _funcionalidad.getDatos)(requestData);
            _context.next = 11;
            break;
...
},{"./articulo":2,"./funcionalidad":3,"regenerator-runtime/runtime":1}]},{},[4]);
